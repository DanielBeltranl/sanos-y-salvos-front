import type { ApiUsuario, ReporteResumen } from './perfilTypes'
import { mapApiUsuarioToPerfil } from './perfilTypes'
...
// Email viene del token de Supabase (user_metadata.email)
